...
describe("Employee class", function() {
    ...
    describe("addEntry(dateStr, amount) method", function() {
        it("Adds an entry to the salaryRecord", function() {
            ...
            assert.equal(emp._salaryRecord.get("1/15/2019"), 3005);
            assert.equal(emp._salaryRecord.get("2/15/2019"), 3150);
            assert.equal(emp._salaryRecord.get("3/15/2019"), 4200);
            assert.equal(emp._salaryRecord.get("4/15/2019"), 2988);
        });
    });
